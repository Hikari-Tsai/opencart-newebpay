				...
				<form action="<?php echo $SpgatewayMPG2_action; ?>" method="post" enctype="multipart/form-data" id="form_SpgatewayMPG2" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<br />
							<!--<input type="checkbox" name="SpgatewayMPG2_payment_methods[ALIPAY]" value="1"<?php if (isset($SpgatewayMPG2_payment_methods['ALIPAY'])) { echo $checked; }	?> />
							<label class="control-label">
								&nbsp;<?php echo $SpgatewayMPG2_text_alipay; ?>
							</label>
							<br />-->
						</div>
					</div>
